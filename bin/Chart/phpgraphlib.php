...
class PHPGraphLib {
	...
	//----------internal publiciables (do not change)------------/
	public $image;
	public $output_file;
	public $error;
	...
	public $horiz_grid_lines;
	public $vert_grid_lines;
	public $horiz_grid_values;
	public $vert_grid_values;
	//text / font
	public $title_x;
	public $title_y;
	//axis points
	...
	public $multi_offset_four = 10; //percent of bar width
	public $multi_offset_five = 9; //percent of bar width
