...
INSERT INTO cm_admin (`ID`, `username`, `password`, `adminname`, `email`, `timevisit`, `online`, `role`) VALUES (2, 'osama', 'c6f057b86584942e415435ffb1fa93d4', 'اسامة احمد سلامة', 'osama_eg@live.com', '1316552530', 'YES', '6');
...
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (4, 'f', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (5, 'sdf', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (6, 'dsf', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (7, 'sd', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (8, 'fsd', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (9, 'f', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (10, 'sdf', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (11, 'sdf', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (12, 'sd', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (13, 'f', NULL, 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (14, 'sdf', NULL, NULL, NULL, 'YES');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (15, 'sdf', 'osama@yahoo.com', 'osama@yahoo.com', NULL, 'NO');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (16, 'sd', 'test test', 'osama@yahoo.com', NULL, 'YES');
INSERT INTO cm_inbox (`ID`, `subject`, `message`, `email`, `dat`, `read`) VALUES (18, NULL, 'osama@yahoo.com', 'osama@yahoo.com', NULL, 'YES');
