...
$base2= base_url("html/application/modules/cp/views/layouts/");
...
$defaultSetting=$this->configer->getConfiger();
 ...
 <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <SCRIPT type=text/javascript src="<?php echo $base2;?>/js/rounded_corners_lite.inc.js"></SCRIPT>
 <link href="<?php echo $base2; ?>/css/<?php echo  $defaultSetting['admin_style'];?>" rel="stylesheet" type="text/css" media="all" />
...
document.form_dir.submit();
 ...
 function addfile(elv){
 var path= document.getElementById('Path').value; 
 
 
 parent.document.getElementById(elv).value=path;
 ...
 parent.$.fancybox.close();
  ...
  function addfileUpload(elv,val){
 var path= document.getElementById('Path').value; 
 path+='/'+val;
 ...
 <input type="button" value="إدراج الملف" style="border:1px #999999 solid; height:25px" 
 onclick="addfile('<?php echo $ItemID;?>');">&nbsp;&nbsp;&nbsp;
 <input type="submit" name="newfolder" value="مجلد جديد"  style="border:1px #999999 solid; height:25px">
  </td>
 <td width="12%" align="left"><input type="text" size="10" class="newinput" name="foldername"></td>
...
<br/> <br/></td><td align="left" valign="top">
<?php
  if(@$uploadresult=='ok'){
?>
<br/>
<input type="button" value="إدراج الملف"  onclick="addfileUpload('<?php echo $ItemID;?>','<?php echo $uploadname;?>');"  style="border:1px #999999 solid; height:25px; font-weight:bold; width:200px"><br/> <br/>
<?php
