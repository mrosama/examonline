...
<CENTER><IMG src="<?php echo base_url("html/application/modules/cp/views/layouts/img/");?>/content.png"  /></CENTER></TD>
 ...
 if(@$addpage=='ok'){
 echo $this->msg->SendMsg(' الصفحات ','   تم إضافة الصفحة ',1);
 } 
...
<table align="center" width="90%" cellpadding="0" cellspacing="0"  class="menu_m6" dir="rtl ">
 ...
 <table width="100%" border="1"    cellpadding="0" cellspacing="3" >
  ...
  <tr><td  align="right" ><input type="text" size="30" name="name" class="newinput"></td><td class="myselect">أسم الصفحة</td></tr>
 <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr> 
 
 <tr><td  align="right" ><input type="text" size="40" name="title" class="newinput"></td><td class="myselect">عنوان الصفحة</td></tr>
 <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
...
<td><IMG src="<?php echo $base;?>/img/pdf_button.png"><input type="checkbox" class="newinput" name="allow_pdf" value="YES" ></td>
 <td align="right" class="myselect">أضف للمفضلة</td>
 <td> <IMG src="<?php echo $base;?>/img/14.png"><input type="checkbox" class="newinput" name="allow_fav" value="YES"></td>
 <td align="right" class="myselect">إرسال لصديق</td>
 <td><IMG src="<?php echo $base;?>/img/icon_envelope.gif"><input type="checkbox" class="newinput" name="allow_send" value="YES"></td>
 <td align="right" class="myselect">طباعة</td>
 <td><IMG src="<?php echo $base;?>/img/print.gif"><input type="checkbox" class="newinput" name="allow_print" value="YES"></td>
 </tr>
 </table>
 </td></tr>
...
<tr><td  align="right"   colspan="2">
 ...
 ?>
<textarea cols="100" rows="20" class="newinput" dir="rtl" name="input" id="input" style="width:80%"></textarea>
...
<tr><td align="right"><input type="radio" value="YES" checked="checked"  name="active" class="newinput"></td><td class="blocks">نعم</td>
<td align="right"><input type="radio" value="NO"   name="active"  class="newinput"></td><td class="blocks">لا</td></tr>
</table>
  </td><td class="blocks">تفعيل الصفحة</td></tr>
   <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
  
  <input type="hidden" value="addpage" name="IsPost">
