...
<table align="center" width="90%" cellpadding="0" cellspacing="0"  class="menu_m6" dir="ltr">
 ...
 <input type="text" size="60" name="subject" class="newinput" style="width:70%" dir="rtl" value=""   ></td>
 <td width="14%" class="myselect">   عنوان الرسالة</td>
 </tr>
  <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>

  <tr><td align="right"  >
 <input type="text" size="60" name="to" class="newinput"   dir="rtl" value="<?php echo @$inbox['email'];?>"></td>
 ...
 <textarea cols="100"   rows="9" name="input" id="input" class="newinput" style="width:70%"><?php echo @$inbox['message'];?></textarea></td> </tr>
 <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
<input type="hidden" value="Send" name="IsPost">
<tr><td  align="center" colspan="2" >

 <input type="button" value="عودة" 
  onClick="location.href=('<?php echo base_url("cp/admin/listemail");?>')" class="button" />
