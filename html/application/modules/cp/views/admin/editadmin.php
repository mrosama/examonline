...
if(@$errors=='update'){
echo $this->msg->SendMsg(' المشرفين ','  تم تعديل المشرف  ',1);
}

if(@$errors=='found'){
echo $this->msg->SendMsg(' المشرفين ','  البريد مسجل من قبل  ',2);
}
 ...
 <tr><td align="right"  >
 <input dir="rtl" type="text" size="40" name="adminname" class="newinput" maxlength="50" value="<?php echo $admindata['adminname'];?>"   ></td>
 <td class="myselect">اسم المشرف</td></tr>
 <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
 <tr><td  align="right" ><input dir="rtl" type="text" size="40" name="email" class="newinput" value="<?php echo $admindata['email'];?>"></td><td class="myselect">البريد الالكتروني</td></tr>
 <tr><td  align="right" ><input dir="rtl" type="text" size="20" name="username" id="username" class="newinput" maxlength="25" style="width:40%" disabled="disabled" value="<?php echo $admindata['username'];?>" /></td><td class="myselect">اسم المستخدم</td></tr>
 ...
 <IMG title="صلاحيات المدير العام إنشاء حسابات المشرفين والتحكم في إعدادات الموقع  " src="<?php echo base_url("html/application/modules/cp/views/layouts/img/");?>/icon14.gif"  />
  ...
  <option value="6" <?php if($admindata['role']=='6'){ echo "selected='selected'";}?>>مدير عام</option>
    <option value="2" <?php if($admindata['role']=='2'){ echo "selected='selected'";}?>>مشرف</option>
  </select>
  </td><td class="myselect">المجموعة</td></tr>
 
 
  <tr><td  align="right" ><input type="password" size="15" name="password" id="pass1" class="newinput" autocomplete="off"  maxlength="15" style="width:20%" ></td>
  <td class="myselect">كلمة المرور</td></tr>
   <tr><td  align="right" >
   <input type="password" size="15" name="cpassword" class="newinput" autocomplete="off" maxlength="15" style="width:20%" ></td><td class="myselect">تأكيد كلمة المرور</td></tr>
...
<tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
 <input type="hidden" value="editAdmin" name="IsPost">
 <input type="hidden" value="<?php echo $admindata['ID'];?>" name="id">
  <input type="hidden" value="<?php echo $admindata['password'];?>" name="old_">
 <tr><td  align="center" colspan="2" >
 
  <input type="submit" value=" حفظ البيانات " class="button"  onClick="return validateadmin(this.form)" >
 
  <input type="button" value=" عودة" class="button"  onClick="location.href=('<?php echo site_url().'/cp/admin/viewadmin';?>')" >
 </td></tr>
 </table>
   </form>
