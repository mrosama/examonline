...
if(@$result=='ok'){
echo $this->msg->SendMsg(' الاعلانات ','   تم إضافة الاعلان  ',1);
}
?>
...
<table align="center" width="90%" cellpadding="0" cellspacing="0"  class="menu_m6" dir="rtl ">
 ...
 <tr><td  align="right" ><input type="text" size="40" name="title" class="newinput" style="width:80%"></td><td class="myselect">اسم الاعلان</td></tr>
 ...
 foreach ($rowcat->result_array() as $row)
{
 ...
 <input type="text"  id="file1" name="file1" class="newinput" style="width:30%" />
...
http://<input type="text" size="40" name="link" class="newinput" style="width:80%" value=""></td><td class="blocks">رابط الاعلان</td></tr>
    <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>


<tr><td  align="right"  valign="top">
<input type="text" size="20"   name="start_date" class="newinput" id="datepicker"></td><td class="blocks">تاريخ بداية الاعلان</td></tr>
    <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
    
    <tr><td  align="right"  valign="top">
<input type="text" size="20"  name="end_date" class="newinput" id="datepicker2"></td><td class="blocks">تاريخ نهاية الاعلان</td></tr>
    <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
...
<tr><td align="right"><input type="radio" value="_self"   name="view" class="newinput"></td><td class="blocks"> في النافذة النشطة</td>
<td align="right"><input type="radio" value="_blank"   name="view" checked="checked" class="newinput"></td><td class="blocks">في نافذة مستقلة</td></tr>
</table>
  </td><td class="blocks">نافذة العرض</td></tr>
   <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
  
  <input type="hidden" value="addbanner" name="IsPost">
