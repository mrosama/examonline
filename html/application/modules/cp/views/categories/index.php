...
<TABLE cellSpacing=0   cellPadding=0  border="1" width="100%">
  ...
  <TR vAlign=top>
    ...
    <TD width='20%'  height="20px"><br/> </TD>
      <TD width="60%" class="myselect" align="right"> ألاقسام</TD>
        <TD width=10>
<CENTER><IMG src="<?php echo base_url("html/application/modules/cp/views/layouts/img/");?>/icon-categories.gif"  /></CENTER></TD>
 ...
 else if(myform.file1.value!="" && pattern.test(myform.file1.value)==false){
 alert("....نوع الصورة غير مسموح بها");
  return false;
 }
else {
...
//echo  @$cat_edit;
 ...
 <td class="myselect">   فرع القسم</td></tr>-->
  <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
 ...
 <input type="text"  id="file1" value="<?php echo $rowss['img'];?>" name="file1" class="newinput" style="width:30%" />
 
 </td>
 <td class="myselect">   صورة القسم</td></tr>
 
 <tr><td   height='1' bgcolor='#CCCCCC' colspan="2"></td></tr>
 
<tr><td  align="center" colspan="2" >
<input type="button" value="عودة " class="button" 
onclick="location.href='<?php echo base_url("cp/categories/index/section/$com_type");?>';">
...
<th id="rating" align="center">صورة</th>
...
echo anchor("cp/categories/index/section/$com_type/edit/$row[ID]",img("$base/img/file_edit.gif"));
 ?>
...
if($row['img']!=""){
?>
<img src="<?php echo Jimage($row['img']);?>" class="smart_frames" border="0" />
<?php
}
?>

</td>
<td align="right"><?php echo $row['name'];?><font color="#FF0000"><?php
...
<?php
echo $this->admin_model->subtree($row['ID'],$com_type);
