...
if(count(@$_SESSION['exam_question'])==0){
redirect('app/', 'refresh');
}

$link3=base_url("app/exam/timer");
?>
...
$this->app_model->save();
redirect("app/exam/mark",'refresh');
}
...
@$exam_duration=$_SESSION['exam_duration'];
 ...
 $_SESSION["exam_rem_duration"]=intval($exam_duration)*60 ;
 }
 else {
...
$current=current($_SESSION['exam_question']);
$key=key($_SESSION['exam_question']);
$end=end($_SESSION['exam_question']);
$total=count($_SESSION['exam_question']);
...
<span style="float:right; width:60%">
 ...
 <tr>
 <td   align="left" class="dor"><?php echo $key+1;?> -<?php echo $total;?>   </td>
<td align="left" class="dor">ألاسئلة</td>
...
?>
<a href="#" onClick="sendform1();"><img src="<?php echo "$base/img/screen.png"?>" border="0" /><br/>&nbsp;&nbsp; عرض العلامات</a>
<?php
}
?>
</td>
...
<td align="center"><input type="submit"  value="السابق" class="buttonnext" name="prev" <?php echo @$disable2;?>></td>
<td align="center"><input  type="submit" value="التالي" class="buttonnext" name="next" <?php echo @$disable;?>></td>
...
<input type="hidden" value="" name="viewmark">
